...
class TestBeaconingAnalyzer(unittest.TestCase):
    ...
    def test_evaluate_batch_for_outliers_not_enough_target_buckets(self):
        ...
        result, documents_need_to_be_removed = analyzer.evaluate_batch_for_outliers(terms=eval_terms_array)
    ...
    def test_evaluate_batch_for_outliers_detect_two_outliers(self):
        ...
        expected_outliers = []
        expected_outliers.append(test_outlier_linux_1)
        expected_outliers.append(test_outlier_linux_2)
