...
def print_intro():
    ...
    if settings.failed_config_paths:
        logging.logger.error("failed to load " + str(len(settings.failed_config_paths)) + " configuration files")
    ...
    if settings.failing_regular_expressions:
        logging.logger.error("failed to parse " + str(len(settings.failing_regular_expressions)) + " regular expressions in whitelist")
