...
class Analyzer(abc.ABC):
    ...
    def _extract_model_settings(self) -> Dict[str, Any]:
        ...
        self.should_run_model: bool = settings.config.getboolean("general", "run_models") and \
                                      settings.config.getboolean(self.config_section_name, "run_model")
        self.should_test_model: bool = settings.config.getboolean("general", "test_models") and \
