    ...
    def run(self) -> None:
        ...
        while not self.shutdown_flag.is_set():
            if settings.config.getboolean("general", "es_wipe_all_whitelisted_outliers"):
                settings.reload_configuration_files()  # reload configuration file, in case new whitelisted items were
                # added by the analyst, they should be processed!
            ...
            logging.logger.info("housekeeping - finished round of cleaning whitelisted items, going to sleep %i " + \
