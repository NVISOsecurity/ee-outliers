...
class AnalyzerFactory:
    ...
    @staticmethod
    def create(config_file: str) -> Optional[Analyzer]:
        ...
        analyzers: List[Optional[Analyzer]] = [AnalyzerFactory.section_to_analyzer(section_name, section) for section_name, section in config.items()]
        ...
        analyzer: Optional[Analyzer] = analyzers[0]
